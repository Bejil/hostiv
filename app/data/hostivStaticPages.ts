...
export const hostivStaticPages: Record<HostivStaticPageId, HostivStaticPage> = {
  "a-propos": {
    id: "a-propos",
    path: "/a-propos",
...
export function getHostivStaticPage(id: HostivStaticPageId): HostivStaticPage {
  return hostivStaticPages[id]
}
