...
const props = defineProps<{ open: boolean; spotTitle: string }>()
    ...
    <Transition name="hostiv-modal-fade">
      <div v-if="open" class="hostiv-modal hostiv-modal--delete" data-backdrop="true" role="presentation" @click="onBackdropClick" @keydown="onKeydown">
        <Transition name="hostiv-modal-panel" appear>
          <div class="hostiv-modal__panel hostiv-modal__panel--delete hostiv-modal__panel--house-rule-delete" role="alertdialog" aria-modal="true" aria-labelledby="admin-welcome-guide-dining-delete-title" aria-describedby="admin-welcome-guide-dining-delete-desc" @click.stop>
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-welcome-guide-dining-delete-title" class="hostiv-modal__title">{{ ui.welcomeGuide.dining.deleteTitle }}</h2>
                <p id="admin-welcome-guide-dining-delete-desc" class="hostiv-modal__subtitle">
                  <strong>{{ spotTitle }}</strong>{{ ui.welcomeGuide.dining.deleteSuffix }}
                </p>
              </div>
            </header>
