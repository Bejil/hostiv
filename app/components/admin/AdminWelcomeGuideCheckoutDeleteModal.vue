      ...
      >
        <Transition name="hostiv-modal-panel" appear>
          <div
            ...
            role="alertdialog"
            aria-modal="true"
            aria-labelledby="admin-welcome-guide-checkout-delete-title"
            aria-describedby="admin-welcome-guide-checkout-delete-desc"
            @click.stop
          >
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-welcome-guide-checkout-delete-title" class="hostiv-modal__title">
                  {{ ui.welcomeGuide.checkout.deleteTitle }}
                </h2>
                <p id="admin-welcome-guide-checkout-delete-desc" class="hostiv-modal__subtitle">
                  <strong>{{ itemTitle }}</strong>{{ ui.welcomeGuide.checkout.deleteSuffix }}
                </p>
              </div>
            </header>
