      ...
      >
        <Transition name="hostiv-modal-panel" appear>
          <div
            ...
            role="alertdialog"
            aria-modal="true"
            aria-labelledby="admin-house-rule-delete-title"
            aria-describedby="admin-house-rule-delete-desc"
            @click.stop
          >
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-house-rule-delete-title" class="hostiv-modal__title">
                  {{ ui.modals.delete.houseRule.title }}
                </h2>
                <p id="admin-house-rule-delete-desc" class="hostiv-modal__subtitle">
                  <strong>{{ ruleTitle }}</strong>{{ ui.modals.delete.houseRule.descriptionTail }}
