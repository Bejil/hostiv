    ...
    <Transition name="hostiv-modal-fade">
      ...
      >
        <Transition name="hostiv-modal-panel" appear>
          <div
            class="hostiv-modal__panel hostiv-modal__panel--delete hostiv-modal__panel--neighborhood-highlight-delete"
            role="alertdialog"
            aria-modal="true"
            aria-labelledby="admin-neighborhood-highlight-delete-title"
            aria-describedby="admin-neighborhood-highlight-delete-desc"
            @click.stop
          >
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-neighborhood-highlight-delete-title" class="hostiv-modal__title">
                  {{ ui.modals.delete.neighborhoodHighlight.title }}
                </h2>
                <p id="admin-neighborhood-highlight-delete-desc" class="hostiv-modal__subtitle">
                  <strong>{{ pointTitle }}</strong
                  >{{ ui.modals.delete.neighborhoodHighlight.descriptionTail }}
