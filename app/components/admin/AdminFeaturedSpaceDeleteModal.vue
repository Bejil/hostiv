    ...
    <Transition name="hostiv-modal-fade">
      ...
      >
        <Transition name="hostiv-modal-panel" appear>
          <div
            class="hostiv-modal__panel hostiv-modal__panel--delete hostiv-modal__panel--featured-space-delete"
            role="alertdialog"
            aria-modal="true"
            aria-labelledby="admin-featured-space-delete-title"
            aria-describedby="admin-featured-space-delete-desc"
            @click.stop
          >
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-featured-space-delete-title" class="hostiv-modal__title">
                  {{ ui.modals.delete.featuredSpace.title }}
                </h2>
                <p id="admin-featured-space-delete-desc" class="hostiv-modal__subtitle">
                  <strong>{{ cardTitle }}</strong>{{ ui.modals.delete.featuredSpace.descriptionTail }}
