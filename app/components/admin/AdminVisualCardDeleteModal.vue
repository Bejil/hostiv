    ...
    <Transition name="hostiv-modal-fade">
      ...
      >
        <Transition name="hostiv-modal-panel" appear>
          <div
            class="hostiv-modal__panel hostiv-modal__panel--delete hostiv-modal__panel--visual-card-delete"
            role="alertdialog"
            aria-modal="true"
            aria-labelledby="admin-visual-card-delete-title"
            aria-describedby="admin-visual-card-delete-desc"
            @click.stop
          >
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-visual-card-delete-title" class="hostiv-modal__title">
                  {{ ui.modals.delete.visualCard.title }}
                </h2>
                <p id="admin-visual-card-delete-desc" class="hostiv-modal__subtitle">
                  <strong>{{ cardTitle }}</strong>{{ ui.modals.delete.visualCard.descriptionTail }}
