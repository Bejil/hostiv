    ...
    <Transition name="hostiv-modal-fade">
      ...
      >
        <Transition name="hostiv-modal-panel" appear>
          <div
            class="hostiv-modal__panel hostiv-modal__panel--delete hostiv-modal__panel--platform-delete"
            role="alertdialog"
            aria-modal="true"
            aria-labelledby="admin-platform-link-delete-title"
            aria-describedby="admin-platform-link-delete-desc"
            @click.stop
          >
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-platform-link-delete-title" class="hostiv-modal__title">
                  {{ ui.modals.delete.platformLink.title }}
                </h2>
                <p id="admin-platform-link-delete-desc" class="hostiv-modal__subtitle">
                  <strong>{{ platformName }}</strong>{{ ui.modals.delete.platformLink.descriptionTail }}
