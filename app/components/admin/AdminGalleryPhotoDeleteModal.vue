    ...
    <Transition name="hostiv-modal-fade">
      ...
      >
        <Transition name="hostiv-modal-panel" appear>
          <div
            class="hostiv-modal__panel hostiv-modal__panel--delete hostiv-modal__panel--gallery-photo-delete"
            role="alertdialog"
            aria-modal="true"
            aria-labelledby="admin-gallery-photo-delete-title"
            aria-describedby="admin-gallery-photo-delete-desc"
            @click.stop
          >
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-gallery-photo-delete-title" class="hostiv-modal__title">
                  {{ ui.gallery.photoDeleteTitle }}
                </h2>
                <p id="admin-gallery-photo-delete-desc" class="hostiv-modal__subtitle">
                  <strong>{{ photoLabel }}</strong>{{ ui.gallery.photoDeleteSuffix }}
                </p>
              </div>
            </header>
