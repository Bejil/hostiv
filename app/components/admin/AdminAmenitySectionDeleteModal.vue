    ...
    <Transition name="hostiv-modal-fade">
      ...
      >
        <Transition name="hostiv-modal-panel" appear>
          <div
            class="hostiv-modal__panel hostiv-modal__panel--delete hostiv-modal__panel--amenity-section-delete"
            role="alertdialog"
            aria-modal="true"
            aria-labelledby="admin-amenity-section-delete-title"
            aria-describedby="admin-amenity-section-delete-desc"
            @click.stop
          >
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-amenity-section-delete-title" class="hostiv-modal__title">
                  {{ ui.modals.delete.amenitySection.title }}
                </h2>
                <p id="admin-amenity-section-delete-desc" class="hostiv-modal__subtitle">
                  <strong>{{ sectionTitle }}</strong>{{ ui.modals.delete.amenitySection.descriptionTail }}
