...
const limitDesc = computed(() =>
  adminUiFormat(ui.value.welcomeGuide.rules.limitDesc, { max: WELCOME_GUIDE_MAX_RULE_COUNT })
)
      ...
      >
        <Transition name="hostiv-modal-panel" appear>
          <div
            ...
            role="alertdialog"
            aria-modal="true"
            aria-labelledby="admin-welcome-guide-rules-limit-title"
            aria-describedby="admin-welcome-guide-rules-limit-desc"
            @click.stop
          >
            ...
            <header class="hostiv-modal__head hostiv-modal__head--delete">
              ...
              <div class="hostiv-modal__head-text">
                <h2 id="admin-welcome-guide-rules-limit-title" class="hostiv-modal__title">
                  {{ ui.welcomeGuide.rules.limitTitle }}
                </h2>
                <p id="admin-welcome-guide-rules-limit-desc" class="hostiv-modal__subtitle">
                  {{ limitDesc }}
                </p>
              </div>
            </header>
