...
export function createEmptyWelcomeGuide(): PropertyWelcomeGuide {
  return {
    ...
    parking_street: DEFAULT_PAGE2.parking_street,
    parking_payment: DEFAULT_PAGE2.parking_payment,
    parking_note: DEFAULT_PAGE2.parking_note,
...
export function applyWelcomeGuideDefaultsFromRecord(
  ...
  return {
    ...
    parking_street: legacyString(guide.parking_street),
    parking_payment: legacyString(guide.parking_payment),
    parking_note: legacyString(guide.parking_note),
...
function normalizePage2And3(
  ...
  return {
    ...
    parking_street: legacyString(v.parking_street),
    parking_payment: legacyString(v.parking_payment),
    parking_note: legacyString(v.parking_note),
...
function migrateLegacyGuide(
  ...
  const base: PropertyWelcomeGuide = {
    ...
    parking_street: legacyString(value?.parking_street),
    parking_payment: legacyString(value?.parking_payment),
    parking_note: legacyString(value?.parking_note),
    welcome_eyebrow: DEFAULT_PAGE2.welcome_eyebrow,
    welcome_banner: DEFAULT_PAGE2.welcome_banner,
    welcome_salutation: DEFAULT_PAGE2.welcome_salutation,
    welcome_body: "",
